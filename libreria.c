...
int menu(){
    ...
    printf(" 7. Ingrese para salir del menu \n");
    scanf("%d", &opcion);
    return opcion;
...
void mostrarEmpleado(eEmpleado unEmpleado)
{
    ...
    printf("%10s %02d     %02d    %.2f    %c         %02d/%02d/%d"
...
void mostrarEmpleados(eEmpleado lista[], int tamanio){
    ...
    printf("nombre    legajo   edad   sueldo   sexo   fecha de ingreso\n");
...
int modificarEmpleado(eEmpleado lista[], int tamanio, int legajo)
{
    ...
    if(lista != NULL && tamanio > 0 && legajo >0)
    {
        cualSeModifica = buscarEmpleado(legajo, lista, tamanio);
